# dev environment params for workforce-identity-federation.
...
# Example:
# group_role_grants = [
#   { entra_group_id = "REPLACE_WITH_ENTRA_ANALYSTS_GROUP_ID", role = "roles/bigquery.dataViewer", level = "project" },
# ]
group_role_grants = []
